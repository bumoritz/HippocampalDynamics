...
for i=1:d_info.numAnimals
    if running(i)==1
        plot([this_data2(i),this_data(i,:)]*100,'-','Color',p.col.runner);
    elseif running(i)==0
        plot([this_data2(i),this_data(i,:)]*100,'-','Color',p.col.nonrunner);
    else
...
for i=1:d_info.numAnimals
    if running(i)==1
        plot(this_data(i,:)*100,'-','Color',p.col.runner);
    elseif running(i)==0
        plot(this_data(i,:)*100,'-','Color',p.col.nonrunner);
    else
