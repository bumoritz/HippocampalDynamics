...
for m=1:length(these_conditions_cells)
    for n=1:length(these_conditions_neg)
        peakTime.(['Atrials_',these_conditions_cells{m},'_nneg',these_conditions_neg{n}]) = cell(d_info.numAnimals,1);
        peakTime.(['Xtrials_',these_conditions_cells{m},'_nneg',these_conditions_neg{n}]) = cell(d_info.numAnimals,1);
        for i=1:d_info.numAnimals
            if ~isempty(idcs.passed_cleaned.([these_conditions_cells{m},'_nneg',these_conditions_neg{n}]){i})
                peakTime.(['Atrials_',these_conditions_cells{m},'_nneg',these_conditions_neg{n}]){i} = ...
                    temp_A{i}(idcs.passed_cleaned.([these_conditions_cells{m},'_nneg',these_conditions_neg{n}]){i});
                peakTime.(['Xtrials_',these_conditions_cells{m},'_nneg',these_conditions_neg{n}]){i} = ...
                    temp_X{i}(idcs.passed_cleaned.([these_conditions_cells{m},'_nneg',these_conditions_neg{n}]){i});
            end
        end
    end
end
...
% Atrials_A_nnegA
this_data_runners = binnedPeakTime.Atrials_A_nnegA(find(running==1),:)*100;
this_data_nonrunners = binnedPeakTime.Atrials_A_nnegA(find(running==0),:)*100;
...
% Atrials_Aonly_nnegA
this_data_runners = binnedPeakTime.Atrials_Aonly_nnegA(find(running==1),:)*100;
this_data_nonrunners = binnedPeakTime.Atrials_Aonly_nnegA(find(running==0),:)*100;
...
% Atrials_AandX_nnegA
this_data_runners = binnedPeakTime.Atrials_AandX_nnegA(find(running==1),:)*100;
this_data_nonrunners = binnedPeakTime.Atrials_AandX_nnegA(find(running==0),:)*100;
...
% Xtrials_X_nnegX
this_data_runners = binnedPeakTime.Xtrials_X_nnegX(find(running==1),:)*100;
this_data_nonrunners = binnedPeakTime.Xtrials_X_nnegX(find(running==0),:)*100;
...
% Xtrials_Xonly_nnegX
this_data_runners = binnedPeakTime.Xtrials_Xonly_nnegX(find(running==1),:)*100;
this_data_nonrunners = binnedPeakTime.Xtrials_Xonly_nnegX(find(running==0),:)*100;
...
% Xtrials_AandX_nnegX
this_data_runners = binnedPeakTime.Xtrials_AandX_nnegX(find(running==1),:)*100;
this_data_nonrunners = binnedPeakTime.Xtrials_AandX_nnegX(find(running==0),:)*100;
