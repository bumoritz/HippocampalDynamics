...
params.addParameter('lineProps', '-k', @(x) ischar(x) | iscell(x) | 1); %MB20210406 | 1 
...
% if ~iscell(lineProps), lineProps={lineProps}; end   %MB20210406
...
function H = makePlot(x,y,errBar,lineProps,transparent,patchSaturation)
    ...
    %H.mainLine=plot(x,y,lineProps{:}); %MB20210406
    H.mainLine=plot(x,y,'Color',lineProps); %MB20210406
