...
dec.supClasses.labels = {'A','X','AB','AY','XY','XB'};
dec.supClasses.labels_extd = {'A_{0s-5.2s}','X_{0s-5.2s}','AB_{5.2s-10.4s}','AY_{5.2s-10.4s}','XY_{5.2s-10.4s}','XB_{5.2s-10.4s}'};
dec.supClasses.numSupClasses = length(dec.supClasses.labels);
dec.supClasses.bins = {16:41,16:41,42:67,42:67,42:67,42:67};
