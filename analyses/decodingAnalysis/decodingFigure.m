...
%% Average posterior snake plots for A and X (all cells)

this_set = 'trainingSet';
this_trialSet = 'trialsForTrainingSet';
...
%% Average posterior snake plots for A and X (only sequence cells)

this_set = 'trainingSet_seq';
this_trialSet = 'trialsForTrainingSet';
