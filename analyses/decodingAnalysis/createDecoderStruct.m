function [decs] = createDecoderStruct(dec,this_data,these_trialsForSet,these_conditions,normalise_data)
% these_trialsForSet = dec.cv.trialsForTrainingSet;
