function [analysis] = analyseDecoding(dec,this_set,these_trials,p)
%dec = dec_all; this_set = 'trainingSet'; these_trials = 1:dec_all.cv.numTrials_trainingSet; 
%dec = dec_all; this_set = 'completeSet'; these_trials = dec_all.cv.trialsForTestSet_incorrM.combined; 
