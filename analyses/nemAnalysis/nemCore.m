...
t_start = tic;
[nem.full.mdl,nem.full.coefs,nemd.full,nem.full.R2_train,nem.full.R2_test,nem.full.R2_all] = ...
...
%             end
        ...
        [nem.testGroupOut{k}.mdl,nem.testGroupOut{k}.coefs,nemd.testGroupOut{k},nem.testGroupOut{k}.R2_train,nem.testGroupOut{k}.R2_test,nem.testGroupOut{k}.R2_all] = ...
            nemFitModel(nem,nemd,p,prop.iscell,these_cells,nem.predictors.Xdsgn,this_exclude);
        
        % calculate residual and use it as Y
        this_Y = nemd.data - nemd.testGroupOut{k};
            
        % fit residual models
        this_exclude = setdiff(1:nem.numPredictors,these_idcs)';
        [nem.testGroupResidual{k}.mdl,nem.testGroupResidual{k}.coefs,nemd.testGroupResidual{k},nem.testGroupResidual{k}.R2_train,nem.testGroupResidual{k}.R2_test,nem.testGroupResidual{k}.R2_all] = ...
