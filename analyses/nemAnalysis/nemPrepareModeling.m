...
% nem.testGroup.label = {'odour','odour_{early}','odour_{late}','1^{st}','1^{st}_{early}','1^{st}_{late}','2^{nd}','2^{nd}_{early}','2^{nd}_{late}',...
%     'A','A_{early}','A_{late}','X','X_{early}','X_{late}','B','B_{early}','B_{late}','Y','Y_{early}','Y_{late}',...
%     'R+L','R','L','run','v','a'};
% nem.testGroup.cols = {p.col.odour,p.col.odour,p.col.odour,p.col.odour,p.col.odour,p.col.odour,p.col.odour,p.col.odour,p.col.odour,...
%     p.col.A,p.col.A,p.col.A,p.col.X,p.col.X,p.col.X,p.col.B,p.col.B,p.col.B,p.col.Y,p.col.Y,p.col.Y,...
%     mean([p.col.reward;p.col.lick]),p.col.reward,p.col.lick,mean([p.col.velocity;p.col.acceleration]),p.col.velocity,p.col.acceleration};
% nem.testGroup.group = {[1:8],[1,3,5,7],[2,4,6,8],[1:4],[1,3],[2,4],[5:8],[5,7],[6,8],...
%     [1:2],[1],[2],[3:4],[3],[4],[5:6],[5],[6],[7:8],[7],[8],...
%     [9:10],[9],[10],[11:12],[11],[12]};
% nem.testGroup.idcs = {}; %{[6:10,16:20,21:25],[6:10,16:20]};
% nem.testGroup.supGroup = [0,0,0,0,0,0,0,0,0,...
