...
% normAvgTraces.firstOdour (e.g. for _stimVersion)
try
    temp = [avgTraces.A_var0(:);avgTraces.X_var0(:)];
    this_lower = nanmin(temp(:));
    this_upper = nanmax(temp(:));
    normAvgTraces.firstOdour.A_var0 = (avgTraces.A_var0-this_lower) ./ (this_upper-this_lower);
    normAvgTraces.firstOdour.X_var0 = (avgTraces.X_var0-this_lower) ./ (this_upper-this_lower);
    temp = [avgTraces.A_var1(:);avgTraces.X_var1(:)];
    this_lower = nanmin(temp(:));
    this_upper = nanmax(temp(:));
    normAvgTraces.firstOdour.A_var1 = (avgTraces.A_var1-this_lower) ./ (this_upper-this_lower);
    normAvgTraces.firstOdour.X_var1 = (avgTraces.X_var1-this_lower) ./ (this_upper-this_lower);
catch
end
