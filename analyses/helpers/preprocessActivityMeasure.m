function [prop,nf_binned,nft_binned] = preprocessActivityMeasure(act,this_p,p,paq_beh,iscell,paq_only)
...
if ~paq_only
    ...
    prop.numFramesTotal = length(paq_beh.position);
end
...
temp(rmmissing(prop.sync_all)) = 1;
